...
class CorrectorBertSCLstm(Corrector):

    def __init__(self, tokenize=True, pretrained=False, device="gpu"):
        super(CorrectorBertSCLstm, self).__init__()
    ...
    def from_pretrained(self, ckpt_path=None, vocab="", weights=""):
        self.ckpt_path = ckpt_path or ARXIV_CHECKPOINTS["bertscrnn-probwordnoise"]
